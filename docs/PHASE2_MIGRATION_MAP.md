...
- Fox and Summertime Saga have deterministic route smoke coverage after T43.
- The tests use router-level builder overrides and existing fake-network screen seams.
